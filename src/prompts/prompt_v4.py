...
- 표현이 관련 기준을 충족하고, 객관적인 근거와 함께 제공되었으며, 허위·과장 요소가 없을 경우에는 **그린워싱이 아닙니다.**
- 특히 다음과 같은 경우 **'그린워싱 없음'**으로 판단해야 합니다:
  1. 환경 관련 주장이 없거나,
  2. 관련 주장이 있지만 **정확한 인증·수치·출처가 명시**되어 있고,
...
**주의: 판단이 불확실하거나 기준 위반이 명확하지 않은 경우, '그린워싱 없음' 또는 '의심'으로 판단하며 그 이유를 근거에 설명하세요.**
"""
